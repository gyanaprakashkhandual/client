...
export function MusicListViewComponent({
  tracks,
  onEdit,
  onDelete,
  onView,
  ...
  const [sortKey, setSortKey] = useState<"title" | "artist" | "album" | "genre" | "releaseDate" | "duration">("title");
          ...
          <thead>
            <tr className="border-b border-neutral-100 dark:border-neutral-800/80">
              <th className="px-5 py-4 text-left w-8">
                <span className="text-[10px] font-bold uppercase tracking-[0.12em] text-neutral-400"></span>
              </th>
