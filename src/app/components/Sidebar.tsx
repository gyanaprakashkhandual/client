...
import { Music, Video, Settings, Play } from "lucide-react";
import { useRouter, usePathname } from "next/navigation";

const NAV_ITEMS = [
  { label: "Music", href: "/music", icon: <Music size={17} strokeWidth={1.6} /> },
  { label: "Vlogs", href: "/vlogs", icon: <Video size={17} strokeWidth={1.6} /> },
];
    ...
    ">
      ...
      <div className="px-6 pt-7 pb-6 border-b border-neutral-100 dark:border-neutral-800">
        <div className="flex items-center gap-2.5">
          <span className="w-7 h-7 rounded-lg bg-black dark:bg-white flex items-center justify-center flex-shrink-0">
            <Play size={11} fill="white" stroke="white" className="dark:fill-black dark:stroke-black ml-0.5" />
          </span>
            ...
            return (
              <li key={item.href}>
                ...
                >
                  ...
                  <span className={`relative z-10 text-[13.5px] font-medium transition-colors ${
                    isActive
                      ? "text-black dark:text-white"
      ...
      <div className="px-3 py-4 border-t border-neutral-100 dark:border-neutral-800">
        ...
        ">
          <Settings size={17} strokeWidth={1.6} className="flex-shrink-0 transition-transform duration-300 group-hover:rotate-45" />
